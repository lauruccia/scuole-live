...
**URL pannello amministrazione:** `https://scuolelive.aealingue.it/admin`
...
- **Amministrazione**: gestisce contratti, pagamenti, configurazione corsi, comunicazioni.
- **Segreteria**: gestisce studenti, lead, comunicazioni, quasi tutto tranne le configurazioni tecniche.
...
- Account Google non collegato o token scaduto: contatta il referente tecnico per ricollegare l'account scuola (procedura di pochi minuti).
- Quasi sempre il sistema rinnova automaticamente il token al prossimo uso. Se non funziona da più di 30 minuti, segnala il problema con l'orario in cui hai notato l'errore così si può andare a leggere il log.
