        ...
        'sections' => [
            ...
            'services' => [
                ...
                'fields' => [
                    ...
                    'services_title' => ['label' => 'Titolo', 'type' => 'html', 'default' => "Una soluzione per <em>ogni esigenza</em>"],
                    ...
                    'service7_title' => ['label' => 'Servizio 7 — titolo', 'type' => 'text', 'default' => "Traduzioni"],
                    'service7_text' => ['label' => 'Servizio 7 — testo', 'type' => 'textarea', 'default' => "Traduzioni semplici, giurate, certificate e con Apostille in Inglese, Francese, Spagnolo, Tedesco, Portoghese, Russo e Arabo, da e verso l'italiano. Ti aiutiamo a verificare i requisiti richiesti dall'ente di destinazione."],
                    'service7_tag' => ['label' => 'Servizio 7 — etichetta', 'type' => 'text', 'default' => "Giurate · Certificate · Apostille"],
                    'service8_title' => ['label' => 'Servizio 8 — titolo', 'type' => 'text', 'default' => "Convenzioni Aziendali"],
                    'service8_text' => ['label' => 'Servizio 8 — testo', 'type' => 'textarea', 'default' => "Per i tuoi corsi personalizzati di Inglese, Francese, Spagnolo, Tedesco, Portoghese, Russo e Arabo puoi utilizzare i voucher aziendali delle realtà convenzionate. Chiedici se la tua azienda è tra queste."],
                    'service8_tag' => ['label' => 'Servizio 8 — etichetta', 'type' => 'text', 'default' => "Voucher aziendali"],
                    'service9_title' => ['label' => 'Servizio 9 — titolo', 'type' => 'text', 'default' => "Vacanze Studio"],
                    'service9_text' => ['label' => 'Servizio 9 — testo', 'type' => 'textarea', 'default' => "English in Action: Summer Camp in collaborazione con \"La Casella\", antico feudo di campagna tra Toscana e Umbria. Il modo migliore per imparare l'inglese divertendosi, immersi in una natura incontaminata."],
                    'service9_tag' => ['label' => 'Servizio 9 — etichetta', 'type' => 'text', 'default' => "Summer Camp"],
                    'service10_title' => ['label' => 'Servizio 10 — titolo', 'type' => 'text', 'default' => "Regala un Corso"],
                    'service10_text' => ['label' => 'Servizio 10 — testo', 'type' => 'textarea', 'default' => "Un regalo utile e originale per compleanno, laurea, promozione o nozze: un corso di lingue individuale o in coppia, online o in presenza, lascia competenze che restano intatte nel tempo."],
                    'service10_tag' => ['label' => 'Servizio 10 — etichetta', 'type' => 'text', 'default' => "Un'idea regalo originale"],
                ],
            ],
            'target' => [
        ...
        'sections' => [
            ...
            'sede' => [
                ...
                'fields' => [
                    ...
                    'sede_highlight' => ['label' => 'Riquadro in evidenza', 'type' => 'html', 'default' => "🎓 <strong>Più di 4.500 facoltà e corsi di laurea riconoscono le certificazioni Trinity.</strong><br>\n            <a href=\"https://www.trinitycollege.it/riconoscimenti/\" target=\"_blank\" rel=\"noopener\">Consulta l'elenco completo dei riconoscimenti →</a>"],
            ...
            'uses' => [
                ...
                'fields' => [
                    ...
                    'use2_text' => ['label' => 'Card 2 — testo', 'type' => 'textarea', 'default' => "Ammissione e crediti per l'idoneità linguistica in più di 4.500 facoltà e corsi di laurea"],
