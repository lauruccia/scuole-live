        ...
        return $form->schema([
                ...
                ->schema([
                    ...
                    Forms\Components\Toggle::make('is_minor')
                        ...
                        ->afterStateUpdated(function (Set $set, $state) {
                            // quando diventa minorenne, espando la section
                            $set('parent_section_open', (bool) $state);
                        }),

                    // Stato UI (solo frontend) per aprire/chiudere la section
                    Forms\Components\Hidden::make('parent_section_open')
                        ->dehydrated(false)
                        ->default(false),
                ]),
            ...
            Forms\Components\Section::make('Residenza')
                ...
                ->schema([
                    ...
                    Forms\Components\TextInput::make('residence_zip')
                        ->label('CAP')
                        ->maxLength(20)
                        ->nullable(),

                    Forms\Components\TextInput::make('residence_city')
                        ->label('Città')
                        ->maxLength(100)
                        ->nullable(),
            ...
            Forms\Components\Section::make('Dati genitore / tutore (se minorenne)')
                ->columns(2)
                ->schema([
                ...
                // chiusa solo se non minorenne, e si apre quando attivi il toggle
