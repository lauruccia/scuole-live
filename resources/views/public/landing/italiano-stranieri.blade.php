...
@section('keywords', 'italiano per stranieri Roma, scuola di italiano per stranieri Roma, corsi italiano stranieri Roma, italiano L2 Roma, preparazione CILS Roma, Italian courses Rome, learn Italian in Rome, Italian school Rome, Italian for foreigners Rome, italiano stranieri San Paolo')
...
<script type="application/ld+json">
{
    ...
    "description": "Italian language courses in Rome for foreigners. All CEFR levels (A1–C2). CILS exam preparation. Native Italian teachers, individual lessons or small groups, in-person or online.",
    "provider": {
...
.cert-cards { display: grid; grid-template-columns: 1fr; max-width: 520px; margin: 0 auto; gap: 22px; }
.cert-card {
...
<section class="page-hero">
    <div class="c page-hero-inner">
        ...
        <p class="subtitle">Impara l'italiano nel cuore di Roma — Learn Italian in the heart of Rome. Corsi per stranieri di tutti i livelli, preparazione esami CILS.</p>
    </div>
</section>
    ...
    <div class="c">
        <div class="bilingual-grid">
            <div class="lang-block">
                ...
                <p>I nostri corsi seguono il <strong>framework europeo CEFR</strong> (A1–C2) e preparano all'esame ufficiale <strong>CILS</strong> (Università per Stranieri di Siena), riconosciuto dallo Stato italiano per cittadinanza, studio, lavoro e residenza.</p>
            ...
            <div class="lang-block">
                ...
                <p>Our courses follow the <strong>CEFR European framework</strong> (A1–C2) and prepare students for the official <strong>CILS</strong> exams (University for Foreigners of Siena), recognized by the Italian government for citizenship, study, work and residence permits.</p>
...
<section class="sec sec-bg">
    <div class="c">
        <div class="sec-header center">
            ...
            <p class="sec-subtext" style="text-align:center;margin:0 auto;">La certificazione CILS è richiesta per la cittadinanza italiana, l'iscrizione a università italiane e molti permessi di soggiorno.</p>
        </div>
